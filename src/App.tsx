...
import DriverTrucks from "./pages/driver/DriverTrucks"; // تأكدنا من استيراد صفحة الشاحنات ✅
      ...
      <TooltipProvider>
        ...
        <BrowserRouter>
          <Routes>
            ...
            {/* 3. التعامل مع الصفحات غير الموجودة */}
